...
final class Int128Vector extends IntVector {
    ...
    Int128Shuffle iotaShuffle(int start, int step, boolean wrap) {
      if (wrap) {
        return (Int128Shuffle)VectorSupport.shuffleIota(ETYPE, Int128Shuffle.class, VSPECIES, VLENGTH, start, step, 1, (l, lstart, lstep) -> new Int128Shuffle(i -> (VectorIntrinsics.wrapToRange(i*lstep + lstart, l))));
      } else {
        return (Int128Shuffle)VectorSupport.shuffleIota(ETYPE, Int128Shuffle.class, VSPECIES, VLENGTH, start, step, 0, (l, lstart, lstep) -> new Int128Shuffle(i -> (i*lstep + lstart)));
      }
    }
