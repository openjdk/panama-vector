...
final class Short64Vector extends ShortVector {
    ...
    ShortVector fromCharArray0(Class<? extends IV> ivClass, Class<IE> ieClass, char[] a, IV offsetMap) {
        return super.fromCharArray0Template(Short64Mask.class, ivClass, ieClass, a, offsetMap);
    }
    ...
    ShortVector fromCharArray0(Class<? extends IV> ivClass, Class<IE> ieClass, char[] a, IV offsetMap, VectorMask<Short> m) {
        return super.fromCharArray0Template(Short64Mask.class, ivClass, ieClass, a, offsetMap, (Short64Mask) m);
    }
    ...
    void intoCharArray0(Class<? extends IV> ivClass, Class<IE> ieClass, char[] a, IV offsetMap) {
        super.intoCharArray0Template(Short64Mask.class, ivClass, ieClass, a, offsetMap);
    }
    ...
    void intoCharArray0(Class<? extends IV> ivClass, Class<IE> ieClass, char[] a, IV offsetMap, VectorMask<Short> m) {
        super.intoCharArray0Template(Short64Mask.class, ivClass, ieClass, a, offsetMap, (Short64Mask) m);
    }
