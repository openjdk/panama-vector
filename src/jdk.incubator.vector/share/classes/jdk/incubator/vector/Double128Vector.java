...
final class Double128Vector extends DoubleVector {
    ...
    Double128Shuffle iotaShuffle(int start, int step, boolean wrap) {
      if (wrap) {
        return (Double128Shuffle)VectorSupport.shuffleIota(ETYPE, Double128Shuffle.class, VSPECIES, VLENGTH, start, step, 1, (l, lstart, lstep) -> new Double128Shuffle(i -> (VectorIntrinsics.wrapToRange(i*lstep + lstart, l))));
      } else {
        return (Double128Shuffle)VectorSupport.shuffleIota(ETYPE, Double128Shuffle.class, VSPECIES, VLENGTH, start, step, 0, (l, lstart, lstep) -> new Double128Shuffle(i -> (i*lstep + lstart)));
      }
    }
    ...
    static final class Double128Mask extends AbstractMask<Double> {
        ...
        public Double128Mask not() {
            return (Double128Mask) VectorSupport.unaryOp(
