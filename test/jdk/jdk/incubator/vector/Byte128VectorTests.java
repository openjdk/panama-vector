...
public class Byte128VectorTests extends AbstractVectorTest {
    ...
    @Test(dataProvider = "byteUnaryOpProvider")
    static void ADDReductionLongByte128VectorTests(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
        ...
        assertReductionLongArraysEquals(a, r, ra, Byte128VectorTests::ADDLong, Byte128VectorTests::ADDLong);
    }
    ...
    @Test(dataProvider = "byteUnaryOpMaskProvider")
    static void ADDReductionLongByte128VectorTestsMasked(IntFunction<byte[]> fa, IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        long[] r = lfr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Byte> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionLongArraysEqualsMasked(a, r, ra, mask, Byte128VectorTests::ADDLongMasked, Byte128VectorTests::ADDLongMasked);
    }
