...
public class Short256VectorTests extends AbstractVectorTest {
    ...
    @Test(dataProvider = "shortUnaryOpProvider")
    static void ADDReductionLongShort256VectorTests(IntFunction<short[]> fa) {
        short[] a = fa.apply(SPECIES.length());
        ...
        assertReductionLongArraysEquals(a, r, ra, Short256VectorTests::ADDLong, Short256VectorTests::ADDLong);
    }
    ...
    @Test(dataProvider = "shortUnaryOpMaskProvider")
    static void ADDReductionLongShort256VectorTestsMasked(IntFunction<short[]> fa, IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        long[] r = lfr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Short> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionLongArraysEqualsMasked(a, r, ra, mask, Short256VectorTests::ADDLongMasked, Short256VectorTests::ADDLongMasked);
    }
