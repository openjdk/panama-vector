...
public class Byte64VectorTests extends AbstractVectorTest {
    ...
    @Test(dataProvider = "byteUnaryOpProvider")
    static void ADDReductionLongByte64VectorTests(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
        ...
        assertReductionLongArraysEquals(a, r, ra, Byte64VectorTests::ADDLong, Byte64VectorTests::ADDLong);
    }
    ...
    @Test(dataProvider = "byteUnaryOpMaskProvider")
    static void ADDReductionLongByte64VectorTestsMasked(IntFunction<byte[]> fa, IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        long[] r = lfr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Byte> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionLongArraysEqualsMasked(a, r, ra, mask, Byte64VectorTests::ADDLongMasked, Byte64VectorTests::ADDLongMasked);
    }
