...
public class Double512VectorTests extends AbstractVectorTest {
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void ADDReductionLongDouble512VectorTests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
        ...
        assertReductionLongArraysEquals(a, r, ra, Double512VectorTests::ADDLong, Double512VectorTests::ADDLong);
    }
    ...
    @Test(dataProvider = "doubleUnaryOpMaskProvider")
    static void ADDReductionLongDouble512VectorTestsMasked(IntFunction<double[]> fa, IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        long[] r = lfr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Double> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionLongArraysEqualsMasked(a, r, ra, mask, Double512VectorTests::ADDLongMasked, Double512VectorTests::ADDLongMasked);
    }
