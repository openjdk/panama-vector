...
public class Int64VectorTests extends AbstractVectorTest {
    ...
    @Test(dataProvider = "intUnaryOpProvider")
    static void ADDReductionLongInt64VectorTests(IntFunction<int[]> fa) {
        int[] a = fa.apply(SPECIES.length());
        ...
        assertReductionLongArraysEquals(a, r, ra, Int64VectorTests::ADDLong, Int64VectorTests::ADDLong);
    }
    ...
    @Test(dataProvider = "intUnaryOpMaskProvider")
    static void ADDReductionLongInt64VectorTestsMasked(IntFunction<int[]> fa, IntFunction<boolean[]> fm) {
        int[] a = fa.apply(SPECIES.length());
        long[] r = lfr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Integer> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionLongArraysEqualsMasked(a, r, ra, mask, Int64VectorTests::ADDLongMasked, Int64VectorTests::ADDLongMasked);
    }
