...
public class Float128VectorTests extends AbstractVectorTest {
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void ADDReductionLongFloat128VectorTests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        ...
        assertReductionLongArraysEquals(a, r, ra, Float128VectorTests::ADDLong, Float128VectorTests::ADDLong);
    }
    ...
    @Test(dataProvider = "floatUnaryOpMaskProvider")
    static void ADDReductionLongFloat128VectorTestsMasked(IntFunction<float[]> fa, IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        long[] r = lfr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Float> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionLongArraysEqualsMasked(a, r, ra, mask, Float128VectorTests::ADDLongMasked, Float128VectorTests::ADDLongMasked);
    }
